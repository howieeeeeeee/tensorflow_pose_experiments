...
def _eval_once(saver, summary_writer, error_op, summary_op, acc_op, labels, eval_output, n, ee_op):
  """Runs Eval once.
  ...
  with tf.Session() as sess:
    ...
    try:
      ...
      while step < num_iter and not coord.should_stop():
        ...
        # print(error)
        print(ee)
        print(sess.run(tf.abs(eval_output-labels)))
        break

        ground_truth.extend(l)
        predict_label.extend(e)
      ...
      np.savetxt("ground_truth_"+str(n)+".txt",g)
