...
tf.app.flags.DEFINE_string('eval_dir', '/data/huozengwei/eval_dir/biwi_2014/biwi_4/',
                           """Directory where to write event logs.""")
tf.app.flags.DEFINE_string('checkpoint_dir', '/data/huozengwei/train_dir/biwi_2014/biwi_4/',
